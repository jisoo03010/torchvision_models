...
Original file is located at
    https://colab.research.google.com/drive/14wt1KBB9scurp_cG2N9RtsomayCVeq-v
"""
...
for t in range(epochs):
  print(f"Epoch {t+1}\n-------------------------------")    
  size = len(datasets['val'])+ len(datasets['train'])
  for ra in range(5):
  ...
  with torch.no_grad(): # gradient(기울기) 계산 context를 비활성화 해주는 역할함 . interence나 va
    ...
    test_accu.append(100 *  (correct / total))     
    print(f"Test Error: Accuracy: {100 *  (correct / total):>0.1f}%, Avg loss: {test_loss1:>8f} \n")
